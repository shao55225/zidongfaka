...
@Table(name = "alipay_agent_draw")
public class AlipayAgentDraw extends Model<AlipayAgentDraw> {

	public static final AlipayAgentDraw dao = new AlipayAgentDraw();
