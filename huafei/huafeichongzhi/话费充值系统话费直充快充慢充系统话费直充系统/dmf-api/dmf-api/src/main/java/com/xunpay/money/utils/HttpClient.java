...
public class HttpClient {
    ...
    private static void config(HttpRequestBase httpRequestBase,String ip,int port) {
        // 设置Header等
    ...
    public static String post(String url, Map<String, Object> params,String ip,int port) throws IOException {
...
//          e.printStackTrace();
    ...
    public static String get(String url,String ip,int port) {
