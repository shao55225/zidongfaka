...
//          e.printStackTrace();
    ...
    public static String sendPostTopUp(String url, Map<String, Object> params, String ip, Integer port, String cokie) throws IOException {
        HttpPost httppost = new HttpPost(url);
        config(httppost, ip, port);
        httppost.setHeader("Origin", "https://upay.10010.com");
        httppost.setHeader("Referer", "https://upay.10010.com/npfwap/npfMobWap/bankcharge/index.html");
...
//          e.printStackTrace();
    ...
    public static String sendGetPayUrl(String url, String ip, Integer port) {
        ...
        httpget.setHeader("Referer", "Referer: https://upay.10010.com");
        CloseableHttpResponse response = null;
        try {
            response = getHttpClient(url, ip, port).execute(httpget, HttpClientContext.create());
            HttpEntity entity = response.getEntity();
