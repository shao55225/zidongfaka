	...
	<div class="am-g">
		<div class="am-u-lg-2">
			<div class="am-input-group am-input-group-secondary am-form-group">
				<a href="${ctx}/company/addApiCompany"><span class="am-input-group-label">新增</span></a>
			</div>
		</div>
		<div class="am-u-lg-5">
			<div class="am-input-group am-input-group-secondary am-form-group">
				...
				<tbody>
					...
					<!--<td>${c.pay_password}</td>
						...
						<td>
							...
							<a href="${ctx}/company/editApiCompany/${c.id}" class="am-btn am-btn-secondary am-btn-xs">编辑</a>
							
							<a href="javascript:deleteItem('${ctx}/company/deleteApiCompany/${c.id}');" class="am-btn am-btn-danger am-btn-xs">删除</a>
						</td>
					</tr>
					</c:forEach>
				</tbody>
