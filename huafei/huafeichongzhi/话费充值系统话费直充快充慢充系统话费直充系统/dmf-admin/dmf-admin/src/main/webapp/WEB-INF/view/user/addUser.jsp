...
<div class="am-cf admin-main">
	...
	<div class="am-g">
		<div class="am-u-lg-12 am-u-md-12 am-u-sm-centered">
			<form class="am-form m-form-horizontal" action="${ctx}/user/saveUser" method="post">
				<div class="am-g am-margin-top">
					<label class="am-u-sm-3 am-text-right">昵称：</label>
					<div class="am-u-sm-6 am-form-group field">
						<input type="text" name="u.nickname" data-validate="required:昵称不能为空">
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-6 am-form-group field">
						<input type="text" name="u.username" data-validate="required:用户名不能为空">
					</div>
					<div class="am-u-sm-3"></div>
				</div>
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-6 am-form-group field">
						<input type="password" name="u.password" data-validate="required:密码不能为空">
					</div>
					<div class="am-u-sm-3"></div>
				</div>
				<div class="am-g am-margin-top">
