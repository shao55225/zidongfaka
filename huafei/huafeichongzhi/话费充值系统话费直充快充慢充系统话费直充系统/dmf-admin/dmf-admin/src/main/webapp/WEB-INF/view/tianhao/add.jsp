...
<div class="am-cf admin-main">
	...
	<div class="am-g">
		<div class="am-u-lg-12 am-u-md-12 am-u-sm-centered">
			<form class="am-form m-form-horizontal" action="${ctx}/tianhao/save" method="post">
				<div class="am-g am-margin-top">
					<label class="am-u-sm-2 am-text-right">昵称：</label>
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="t.nickname" data-validate="required:昵称不能为空">
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="t.url" data-validate="required:地址不能为空">
					</div>
					<div class="am-u-sm-1"></div>
				</div>
