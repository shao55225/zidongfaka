...
<div class="am-cf admin-main">
	...
	<div class="am-g">
		<div class="am-u-lg-12 am-u-md-12 am-u-sm-centered">
			<form class="am-form m-form-horizontal" action="${ctx}/order/updateSettleItem" method="post">
				<div class="am-g am-margin-top">
					<label class="am-u-sm-2 am-text-right">姓名：</label>
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="s.alipay_name" value="${s.alipay_name}" data-validate="required:支付宝姓名不能为空">
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="s.alipay_account" value="${s.alipay_account}" data-validate="required:支付宝账号不能为空">
					</div>
					<div class="am-u-sm-1"></div>
				</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="s.pid" value="${s.pid}" data-validate="required:PID不能为空">
					</div>
					<div class="am-u-sm-1"></div>
				</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-3 am-form-group field">
						<select name="s.status" class="am-form-field">
							...
							<option ${s.status == "禁用" ? "selected" : ""}>禁用</option>
				   		</select>
					</div>
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-5 am-form-group field">
						<input type="text" name="s.max_money" value="${s.max_money}" data-validate="required:限额不能为空">
					</div>
					<div class="am-u-sm-5">
				...
				<div class="am-g am-margin-top">
					...
					<div class="am-u-sm-9 am-form-group field">
						<input type="text" name="s.remark" value="${s.remark}" >
					</div>
					<div class="am-u-sm-1"></div>
				</div>
